...
class BlogPostDAO:
    ...
    def add_comment(self, permalink, name, email, body):
        ...
        try:
            updated = self.posts.update({"permalink": permalink}, {"$addToSet": {"comments": comment}})

            return updated["nModified"]  # Change this to return the number of documents updated by the code for HW 3.3
